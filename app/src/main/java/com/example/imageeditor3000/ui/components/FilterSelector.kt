...
import com.example.imageeditor3000.data.model.FilterCategory
...
fun FilterSelector(
    ...
    var selectedCategory by remember { mutableStateOf(com.example.imageeditor3000.data.model.FilterCategory.BASIC) }
    ...
    Column(modifier = modifier) {
        ...
        Row(
            ...
            com.example.imageeditor3000.data.model.FilterCategory.entries.forEach { category ->
                FilterChip(
...
private fun FilterList(
    category: com.example.imageeditor3000.data.model.FilterCategory,
    ...
    Column(
        ...
        when (category) {
            com.example.imageeditor3000.data.model.FilterCategory.BASIC -> {
                BasicFiltersList(currentFilter, onFilterClick)
            }
            com.example.imageeditor3000.data.model.FilterCategory.ADVANCED -> {
                AdvancedFiltersList(currentFilter, onFilterClick)
            }
            com.example.imageeditor3000.data.model.FilterCategory.TRANSFORM -> {
 ...
 */
private fun getCategoryName(category: com.example.imageeditor3000.data.model.FilterCategory): String {
    return when (category) {
        com.example.imageeditor3000.data.model.FilterCategory.BASIC -> "Básicos"
        com.example.imageeditor3000.data.model.FilterCategory.ADVANCED -> "Avanzados"
        com.example.imageeditor3000.data.model.FilterCategory.TRANSFORM -> "Transformar"
    }
}